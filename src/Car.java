...
public class Car
{
    ...
    /**/private static double m_R = 8.0; // mass of rear wheel (kg)
    /**/private static double m_F = 8.0; // mass of front wheel (kg)
    /**/private static double m_C = 1300; // mass of frame (kg)
    private static double I_zzR = 0.72; // moment of inertia of rear wheels (kg-m^2)
    private static double I_zzF = 0.72; // moment of inertia of front wheels (kg-m^2)
    private static double I_zzC = 11700; // moment of inertia of the car frame (kg-m^2)

    // Constants regarding the car's suspension system and the car's physical dimensions:
    /**/public static double R = 0.4318; // wheel radius (m)
    /**/public static double d = 5.0800; // distance between the wheels (m)
    public static double s_x = 3; // x-distance between rear wheel and frame's center of mass (m)
    public static double s_y = 0.5; // y-distance between wheels and frame's center of mass (m)
    /**/private static double k = 2500.0; // The spring coefficient of the car's suspension system (N/m)
    private static double h = 1000.0; // The dampening coefficient of the car's suspension system (N-s/m)

    // Constants regarding the environment
    /**/private static double mu = 0.7; // coefficient of friction between wheels and ground (unitless)
    private static double f_max = 500; // maximum static friction (N)
